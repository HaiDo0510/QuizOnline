                    ...
                    <div className="w3-row">
                        <div className="w3-col l3 s6">
                            <div className="w3-container">
                                <img src={require("../../image/logo5.jpg")} style={{ width: '100%' }} />
                                <p>Ripped Skinny Jeans<br /><b>$24.99</b></p>
                            </div>
                            <div className="w3-container">
                                <img src={require("../../image/logo4.jpg")} style={{ width: '100%' }} />
                        ...
                        <div className="w3-col l3 s6">
                            <div className="w3-container">
                                <div className="w3-display-container">
                                    <img src={require("../../image/logo6.png")} style={{ width: '100%' }} />
                            ...
                            <div className="w3-container">
                                <img src={require("../../image/logo7.png")} style={{ width: '100%' }} />
                                <p>Washed Skinny Jeans<br /><b>$20.50</b></p>
                            </div>
                        </div>
                        <div className="w3-col l3 s6">
                            <div className="w3-container">
                                <img src={require("../../image/logo8.jpg")} style={{ width: '100%' }} />
                                <p>Washed Skinny Jeans<br /><b>$20.50</b></p>
                            </div>
                            <div className="w3-container">
                                <div className="w3-display-container">
                                    <img src={require("../../image/logo7.jpg")} style={{ width: '100%' }} />
                        ...
                        <div className="w3-col l3 s6">
                            <div className="w3-container">
                                <img src={require("../../image/logo8.png")} style={{ width: '100%' }} />
                                <p>Vintage Skinny Jeans<br /><b>$14.99</b></p>
                            </div>
                            <div className="w3-container">
                                <img src={require("../../image/logo6.jpg")} style={{ width: '100%' }} />
                                <p>Ripped Skinny Jeans<br /><b>$24.99</b></p>
                            </div>
                        </div>
                    </div>
